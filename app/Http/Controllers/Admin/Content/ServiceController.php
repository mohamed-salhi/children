...
//       return $services = SectionService::query()->orderByDesc('created_at')->get();
        ...
        return view('admin.content.section_services');
    }
    ...
    public function update(Request $request)
    {
        ...
        foreach (locales() as $key => $language) {
            ...
            $rules['button_' . $key] = 'required|string|max:255';
        ...
        $service = SectionService::query()->findOrFail($request->id);
        $service->update($data);
    ...
    {
        $services = SectionService::query()->orderByDesc('created_at');
