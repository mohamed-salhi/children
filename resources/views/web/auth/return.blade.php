...
<div class="container mx-auto flex justify-center items-start mt-20">
    <div class="signinCard w-full md:w-1/2">
        ...
        @include('web.errors')
        <form id="edit-password-form"  method="post" action="{{ route('user.changePassword') }}">
            @csrf
            <input type="hidden" value="{{$email}}" name="email" class="form-control shadow-none" id="exampleInputEmail1">

            <div class="form-group mt-8">
                <label for="" class="text-[#000100] text-base">New Password</label>
                <div class="relative">
                    <input style="box-shadow: 0px 0px 3px 0px #00000040;" type="password"
                           class="password bg-white p-2 rounded-md mt-2 w-full transition-all duration-200 focus:outline-0 focus:scale-105 focus:border focus:border-[#095533]"
                           name="password">
            ...
            <div class="form-group mt-8">
                <label for="" class="text-[#000100] text-base">Confirm Password</label>
                <div class="relative">
                    <input style="box-shadow: 0px 0px 3px 0px #00000040;" type="password"
                           class="password bg-white p-2 rounded-md mt-2 w-full transition-all duration-200 focus:outline-0 focus:scale-105 focus:border focus:border-[#095533]"
