...
<div class="container mx-auto flex justify-center items-start mt-20">
    <div class="signinCard w-full md:w-1/2">
        <h1 class="text-4xl font-medium">@lang Sign In @endlang</h1>
            ...
            <div class="form-group mt-8">
                ...
                <div class="relative">
                    <input style="box-shadow: 0px 0px 3px 0px #00000040;" type="password"
                           ...
                           name="password">
                    <div class="absolute right-2 top-4 text-[#095533] eye"><i
                            class="far fa-eye-slash"></i></div>
                </div>
            </div>

            <div class="flex flex-col justify-center items-center my-10">
                <button type="submit" class="bg-[#095533] text-white py-2 px-6 rounded-full mb-2">@lang('Sign In')</button>
            </div>
        </form>
    </div>
</div>
