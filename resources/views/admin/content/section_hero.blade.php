                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <form action="{{ route('content.postHeroSection') }}" method="POST"id="add-mode-form" class="add-mode-form"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                           ...
                                                           name="title_{{ $key }}" value="{{$hero->getTranslation('title', $key) }}" >
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               ...
                                                               name="details_{{ $key }}" value="{{$hero->getTranslation('details', $key)  }}" >
                                                        <div class="invalid-feedback"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                               ...
                                                               name="button_{{ $key }}"  value="{{$hero->getTranslation('button', $key)  }}">
                                                        <div class="invalid-feedback"></div>
                                                    </div>
                                                </div>
