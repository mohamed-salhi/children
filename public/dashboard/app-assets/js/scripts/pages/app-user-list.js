...
$(function () {
  ...
  var dtUserTable = $('.users-list-table'),
    newUserSidebar = $('.new-users-modal'),
    newUserForm = $('.add-new-users'),
    statusObj = {
  ...
  var assetPath = '../../../app-assets/',
    userView = 'app-users-view.html',
    userEdit = 'app-users-edit.html';
  if ($('body').attr('data-framework') === 'laravel') {
    assetPath = $('body').attr('data-asset-path');
    userView = assetPath + 'app/users/view';
    userEdit = assetPath + 'app/users/edit';
  }

  // Users List datatable
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: assetPath + 'data/users-list.json', // JSON file to add data
      columns: [
